...
contract VMAINToken is ERC20, Ownable {
    using SafeMath for uint256;

    string private constant NAME = "vMainFrameToken"; // Token Name
    string private constant SYMBOL = "VMAIN"; // Token Symbol
     ...
     * construction.
     */
    constructor(uint256 totalSupply_, address payable _vmainAdmin)
        public
        ERC20(NAME, SYMBOL)
    {
        transferOwnership(_vmainAdmin);
        _mint(_vmainAdmin, totalSupply_);
    }
